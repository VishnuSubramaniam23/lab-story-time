...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInNMeters, metersToTravel){
    let result;
    if (Number.isInteger( totalNoOfSweets) && Number.isInteger( sweetsConsumedByKaren) &&
        Number.isInteger(sweetsConsumedInNMeters) && Number.isInteger(metersToTravel)) 
        {
        result = totalNoOfSweets - (sweetsConsumedByKaren + sweetsConsumedInNMeters * metersToTravel);
        return result / 2;
    } 
    else {
...
function aDifficultChoice(choice) {
    switch (choice) {
        case 1:
            ...
            break;
        case 2:
            return "Talk to her husband about the issue";
            break;
        case -1:
